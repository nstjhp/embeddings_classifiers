...
def main():
    ...
    parser.add_argument("--cols-to-drop", nargs="*", default=['h5_index', 'FDHevidence', 'dataset_tag'], help="Name(s) of unneeded columns e.g. --cols-to-drop h5_index nar_evidence.")
